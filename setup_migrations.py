...
def main():
    ...
    schema_file = os.path.join(os.path.dirname(__file__), 'database_migrations.sql')
    ...
    try:
        ...
        print("\nNote: Si la fonction RPC n'existe pas, vous devrez exécuter le fichier database_migrations.sql manuellement dans l'éditeur SQL de votre tableau de bord Supabase.")
